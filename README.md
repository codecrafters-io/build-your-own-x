...
* [**C++**: _Ray Tracing in One Weekend](https://raytracing.github.io/books/RayTracingInOneWeekend.html)
...
* [**Dockerfile**: Dockerize a crypto miner](https://ryigitkader.medium.com/create-a-crypto-miner-docker-image-77eb487c833f)
...
* [**Node.js**: _How to build a SlackBot with Node.js and SlackBots.js_](https://www.freecodecamp.org/news/building-a-slackbot-with-node-js-and-slackbots-js/)
...
* [**Python**: _Bot for vaccine booking from COWIN website (COVID VACCINE SHOTS_](https://medium.com/cloudfordummies/building-a-telegram-bot-for-cowin-shot-slots-9b15355c5b8e)
...
* [**Ruby**: _Redis in Ruby_](https://redis.pjam.me/)
- [Back to top](#table-of-contents)
...
* [**Java**: Your Own Proxy Server ](https://people.apache.org/~jim/NewArchitect/webtech/2001/04/java/index.html)
* [**Proxy server**: Building your own proxy server](https://networkjutsu.com/building-your-own-proxy-server/)
* [**Proxy server**: Guide to Make Your Own Proxy for More IPs](https://dzone.com/articles/guide-to-make-your-own-proxy-for-more-ips)
...
* [**(any)**: AI Roadmap](https://github.com/microsoft/ML-For-Beginners)
...
* [**Python**: _An Introduction to RLU in Artificial Neural Networks](https://www.nbshare.io/notebook/584445049/Rectified-Linear-Unit-For-Artificial-Neural-Networks-Part-1-Regression/)
...
* [**Python**: ML Leaning tutorial for beginners](https://github.com/microsoft/ML-For-Beginners)
...
* [**Rust**: _Build a terminal emulator from scratch_](https://www.poor.dev/blog/terminal-anatomy/)
...
* [**C#**: Monaidc parser combinators](https://tyrrrz.me/blog/monadic-parser-combinators)
...
* [**PHP**: _Advanced PHP MVC Blog System_](https://www.youtube.com/playlist?list=PLGO8ntvxgiZPZBHUGED6ItUujXylNGpMH) [video]
